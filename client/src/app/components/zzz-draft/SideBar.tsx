...
const menuItems = [
  { id: 1, label: "HOME", icon: <Home size={20} />, value: SidebarMenu.Home },
  {
    ...
    label: "PROFILE",
    icon: <User size={20} />,
    value: SidebarMenu.Profile,
  },
  {
    id: 3,
    label: "DRAFTS",
    icon: <FlaskConical size={20} />,
    value: SidebarMenu.Drafts,
  },
  {
    id: 4,
    label: "TOURNAMENTS",
    icon: <Trophy size={20} />,
    value: SidebarMenu.Tournaments,
  },
  {
    id: 5,
    label: "DRAFT SYSTEMS",
    icon: <Settings size={20} />,
    value: SidebarMenu.DraftSystems,
  },
];
        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`
                                w-full cursor-pointer py-3 px-4 rounded-lg text-left font-semibold uppercase tracking-wide 
